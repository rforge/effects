...
@
The \fn{Effect.gls} function has three required arguments: \code{focal.predictors} and \code{mod}, which match the named arguments of the \fn{Effect} generatic function and the first two named arguments of \fn{Effect.default}; and  \code{...}, which matches any other arguments to be passed to \fn{Effect.default} (see \code{help("Effect")} for a list of these arguments).
